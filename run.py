...
def load_config():
    ...
    # parser.add_argument('--root', type=str, default='/home/boot/whx/CDAN/data/office', help="root")
    ...
    parser.add_argument('--root', type=str, default='/home/boot/whx/CDAN/data/office-home/', help="root")
    ...
    # parser.add_argument('--tag', type=str, default='visda', help="Tag")
    # parser.add_argument('--root', type=str, default='/home/boot/whx/CDAN/data/visda/', help="root")
    # parser.add_argument('--source', type=str, default='train_list.txt', help="The source dataset")
    # parser.add_argument('--target', type=str, default='validation_list.txt', help="The target dataset")
    # parser.add_argument('--num_class', default=12, type=int, help='Number of clusters in Spectral Clusting(defa')
